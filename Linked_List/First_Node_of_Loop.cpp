...
class LinkedList{
    ...
    LLNode * firstNodeOfLoop(){
        ...
        if (flag){
            if (slow==head){ //This is needed in the case like 1 2 3 4 5 and 5->next=1
                return slow;
            }
            else{
            slow=head;
...
int main(){
    ...
    LinkedList l1;
    l1.head=n1;
    LLNode *node=l1.firstNodeOfLoop();
    cout << node->data;
    ...
    l2.head=n5;
    cout <<endl;
    LLNode *node1=l2.firstNodeOfLoop();
    cout << node1->data;
    return 0;
}